...
import { PlannedActivityItem } from './planned_activity_item.model';
  ...
  export class PlannedActivity extends Model<PlannedActivity> {
    ...
    @Column({ type: DataType.BOOLEAN, defaultValue: true }) declare category_is_custom: boolean;
    ...
    @Column({ type: DataType.INTEGER, allowNull: true }) declare recurring_days?: number;
