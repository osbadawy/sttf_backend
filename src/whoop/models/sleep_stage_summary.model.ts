...
export class WhoopSleepStageSummary extends Model<WhoopSleepStageSummary> {
  ...
  @Column({ type: DataType.BIGINT, field: 'total_in_bed_time_milli' })
  declare total_in_bed_time_milli: number;
  @Column({ type: DataType.BIGINT, field: 'total_awake_time_milli' })
  declare total_awake_time_milli: number;
  @Column({ type: DataType.BIGINT, field: 'total_no_data_time_milli' })
  declare total_no_data_time_milli: number;
  @Column({ type: DataType.BIGINT, field: 'total_light_sleep_time_milli' })
  declare total_light_sleep_time_milli: number;
  @Column({ type: DataType.BIGINT, field: 'total_slow_wave_sleep_time_milli' })
  declare total_slow_wave_sleep_time_milli: number;
  @Column({ type: DataType.BIGINT, field: 'total_rem_sleep_time_milli' })
